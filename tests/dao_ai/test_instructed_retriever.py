...
class TestRRFMerge:
    ...
    def test_k_parameter_affects_scoring(self) -> None:
        ...
        diff_low = result_low_k[0].metadata["rrf_score"] - result_low_k[1].metadata["rrf_score"]
        diff_high = result_high_k[0].metadata["rrf_score"] - result_high_k[1].metadata["rrf_score"]
...
class TestDecomposeQuery:
    ...
    @patch("dao_ai.tools.instructed_retriever._load_prompt_template")
    def test_decompose_query_respects_max_subqueries(self, mock_load_prompt: MagicMock) -> None:
