...
```bash
dao-ai chat -c config/examples/05_human_in_the_loop/human_in_the_loop.yaml
```
...
👉 **06_guardrails/** - Automated safety checks  
👉 **08_orchestration/** - Multi-agent workflows with HITL  
👉 **09_complete_applications/** - See HITL in production apps
